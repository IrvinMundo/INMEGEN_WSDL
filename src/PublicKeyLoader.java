...
public class PublicKeyLoader implements KeyLoader {
    ...
    public PublicKeyLoader(String certificateLocation) throws KeyException {
        try {
    ...
    public PublicKeyLoader(InputStream crtInputStream) throws KeyException {
        this.setX509Certificate(crtInputStream);
    }



    public void setX509Certificate(InputStream crtInputStream) throws KeyException {
        try {
